...
@extends('layouts.app')
@section('mypage')
<h1 style=" color:brown;margin-left: 150px;font-family:lucida calligraphy"> Available Cources</h1>
  ...
  <div class="card">
    ...
    <div class="card-body" style="background-color: bisque;color:">
      <blockquote class="blockquote mb-0">
        ...
        <h3>Duration : </h3>
        <p>{{$item["duration"]}}</p>
        <a class="btn btn-outline-success ms-3 " href="{{route("user.cources",$item->id)}}" role="button" style="float:right"> Enroll</a>
